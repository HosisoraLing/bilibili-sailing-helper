...
def test_worker_waits_for_new_cookie_after_bilibili_minus_352():
    async def run_test():
        ...
        from services.bilibili_live.api import BilibiliApiError
        ...
        assert webhook.heartbeats[0] == {
            ...
            "bilibili_api_url": "https://api.live.bilibili.com/xlive/web-room/v1/index/getDanmuInfo",
            "bilibili_error": "-352",
            "bilibili_code": -352,
            "bilibili_http_status": 200,
