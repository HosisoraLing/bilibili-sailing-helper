# split-runtime-roles Specification

## Purpose
Define the production runtime split between web, danmaku-worker, and scheduler roles so background listeners and periodic jobs communicate through authenticated internal APIs while web remains the owner of direct business database writes.
