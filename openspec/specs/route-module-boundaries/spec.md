...
Define the compatibility and ownership rules for keeping Flask route handlers split into focused modules without changing public URLs, endpoint names, admin protections, or internal API contracts.
## Requirements
